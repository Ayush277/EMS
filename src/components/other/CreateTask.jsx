...
const <div className='p-5 bg-gray-900 mt-7 rounded'>
    <form className='flex flex-wrap w-full items-start justify-between'>
        <div className='w-1/2'>
            ...
            <button className='bg-black py-3 hover:bg-red-500 px-5 rounded text-sm mt-4 w-full'>Create Task</button>
    </form>
</div> = () => {
  return (
    <div>
...
export default <div className='p-5 bg-gray-900 mt-7 rounded'>
    <form className='flex flex-wrap w-full items-start justify-between'>
        <div className='w-1/2'>
            <div>
                <h3 className='text-sm text-gray-300 mb-0.5'>Task Title</h3>
